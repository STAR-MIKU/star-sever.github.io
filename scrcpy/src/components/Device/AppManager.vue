...
const selectedApp = ref<ExtendedPackageInfo | null>(null);
...
const confirmUninstall = async () => {
  if (!client.device || !packageManager.value || !selectedApp.value) return;

  try {
    selectedApp.value.uninstalling = true;
    ...
    if (selectedApp.value) {
      selectedApp.value.uninstalling = false;
    }
  }
};
